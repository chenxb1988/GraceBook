package com.grace.book.widget.spinner;
...
public abstract class NiceSpinnerBaseAdapter<T> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            textView = (ColorTextView) convertView.findViewById(R.id.tv_tinted_spinner);
        ...
        textView.setTextColor(ThemeUtils.getThemePrimaryColor(mContext));
    ...
    protected static class ViewHolder {
        ...
        public ViewHolder(ColorTextView textView) {
