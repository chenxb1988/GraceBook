...
//        recyclerView = (RecyclerView) findViewById(R.id.rv);
    ...
    private void initItemsData() {
        ...
        items.add(new Item(R.drawable.logo, "Image 1", 20, 33));
        items.add(new Item(R.drawable.logo, "Image 2", 10, 54));
        items.add(new Item(R.drawable.logo, "Image 3", 27, 20));
        items.add(new Item(R.drawable.logo, "Image 4", 45, 67));
    }
