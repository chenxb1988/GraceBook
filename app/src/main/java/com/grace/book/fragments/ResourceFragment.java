 ...
 */
public class ResourceFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    private void getData(final boolean isRefresh) {
        RequestManager.get(getName(), "http://gank.io/api/data/拓展资源/"
