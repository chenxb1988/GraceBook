...
public class CropUtils {
     ...
     */
    public CropUtils output(Uri output) {
     ...
     * @param y Aspect Y
     */
    public CropUtils withAspect(int x, int y) {
    ...
    /**
     * CropUtils area with fixed 1:1 aspect ratio
     */
     ...
     */
    public CropUtils withMaxSize(int width, int height) {
...
//        cropIntent.setClass(context, CropImageActivity.class);
    ...
    public static void pickImage(Activity activity) {
        ...
        try {
            ...
            ToastUtils.showErrorToasty(activity, "crop pick error");
        }
    }
